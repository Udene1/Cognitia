...
def build_cognitive_representation(
    ...
    *,
    ...
    goals = tuple(
        CognitiveGoal(operation=operation, target=frame.text)
    ...
    statuses = tuple(
        dict.fromkeys(
            ...
            for proposition in frame.semantic_propositions
        )
    )
    propositions = tuple(
        proposition.text for proposition in frame.semantic_propositions
    )
